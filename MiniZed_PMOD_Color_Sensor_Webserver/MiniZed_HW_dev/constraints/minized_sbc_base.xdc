...
set_property PACKAGE_PIN M15 [get_ports {PMOD1_LED[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PMOD1_LED[0]}]
#######################################################################
#AXI IIC 2
...
set_property PACKAGE_PIN P13 [get_ports {PMOD2_SWT[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PMOD2_SWT[0]}]
set_property PACKAGE_PIN P14 [get_ports {PMOD2_SWT[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PMOD2_SWT[1]}]
set_property PACKAGE_PIN N11 [get_ports {PMOD2_SWT[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PMOD2_SWT[2]}]
set_property PACKAGE_PIN N12 [get_ports {PMOD2_SWT[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PMOD2_SWT[3]}]
