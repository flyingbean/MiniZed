...
################################################################
# This is a generated script based on design: minized_sbc_base
#
...
# source minized_sbc_base_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# led_mgr, microphone_mgr, pwm, wireless_mgr
...
set design_name minized_sbc_base
...
proc create_root_design { parentCell } {
  ...
  set PMOD1_LED [ create_bd_port -dir O -from 0 -to 0 PMOD1_LED ]
  set PMOD2_SWT [ create_bd_port -dir I -from 3 -to 0 PMOD2_SWT ]
  ...
  # Create instance: pdm_filt_0, and set properties
...
1#UART 1#Unbonded#Unbonded#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M02_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins ps7_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M03_AXI [get_bd_intf_pins bluetooth_uart/S_AXI] [get_bd_intf_pins ps7_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M04_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins ps7_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins ps7_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M06_AXI [get_bd_intf_pins ps7_axi_periph/M06_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  connect_bd_intf_net -intf_net ps7_axi_periph_M07_AXI [get_bd_intf_pins axi_iic_1/S_AXI] [get_bd_intf_pins ps7_axi_periph/M07_AXI]

  # Create port connections
  connect_bd_net -net AUDIO_DAT_1 [get_bd_ports AUDIO_DAT] [get_bd_pins microphone_mgr_0/AUDIO_DAT]
  ...
  connect_bd_net -net Net [get_bd_ports WL_SDIO_DAT] [get_bd_pins wireless_mgr_0/WL_SDIO_DAT]
  connect_bd_net -net Net1 [get_bd_ports WL_SDIO_CMD] [get_bd_pins wireless_mgr_0/WL_SDIO_CMD]
  connect_bd_net -net PMOD2_SWT_1 [get_bd_ports PMOD2_SWT] [get_bd_pins pwm_0/duty]
  ...
  connect_bd_net -net axi_iic_1_iic2intc_irpt [get_bd_pins axi_iic_1/iic2intc_irpt] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net bluetooth_uart_ip2intc_irpt [get_bd_pins bluetooth_uart/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net bluetooth_uart_rtsn [get_bd_pins bluetooth_uart/rtsn] [get_bd_pins wireless_mgr_0/ZYNQ_UART_RTS]
  connect_bd_net -net bluetooth_uart_sout [get_bd_pins bluetooth_uart/sout] [get_bd_pins wireless_mgr_0/ZYNQ_UART_TX]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_iic_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins bluetooth_uart/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/M01_ACLK] [get_bd_pins ps7_axi_periph/M02_ACLK] [get_bd_pins ps7_axi_periph/M03_ACLK] [get_bd_pins ps7_axi_periph/M04_ACLK] [get_bd_pins ps7_axi_periph/M05_ACLK] [get_bd_pins ps7_axi_periph/M06_ACLK] [get_bd_pins ps7_axi_periph/M07_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins proc_sys_reset_50MHz/slowest_sync_clk] [get_bd_pins pwm_0/clk]
  ...
  connect_bd_net -net microphone_mgr_0_AUDIO_CLK [get_bd_ports AUDIO_CLK] [get_bd_pins microphone_mgr_0/AUDIO_CLK]
  connect_bd_net -net microphone_mgr_0_AUDIO_PDM [get_bd_pins microphone_mgr_0/AUDIO_PDM] [get_bd_pins pdm_filt_0/pdm_in]
  connect_bd_net -net pdm_filt_0_audio_out [get_bd_pins led_mgr_0/AUDIO_RAW] [get_bd_pins pdm_filt_0/audio_out]
  ...
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_iic_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins bluetooth_uart/s_axi_aresetn] [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/M01_ARESETN] [get_bd_pins ps7_axi_periph/M02_ARESETN] [get_bd_pins ps7_axi_periph/M03_ARESETN] [get_bd_pins ps7_axi_periph/M04_ARESETN] [get_bd_pins ps7_axi_periph/M05_ARESETN] [get_bd_pins ps7_axi_periph/M06_ARESETN] [get_bd_pins ps7_axi_periph/M07_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net proc_sys_reset_50MHz_peripheral_aresetn [get_bd_pins proc_sys_reset_50MHz/peripheral_aresetn] [get_bd_pins pwm_0/reset_n]
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps7/FCLK_CLK0]
  connect_bd_net -net ps7_FCLK_CLK1 [get_bd_pins bluetooth_uart/xin] [get_bd_pins ps7/FCLK_CLK1]
  connect_bd_net -net ps7_FCLK_CLK2 [get_bd_pins led_mgr_0/clk_in] [get_bd_pins microphone_mgr_0/clk_in] [get_bd_pins pdm_filt_0/clk] [get_bd_pins ps7/FCLK_CLK2]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins led_mgr_0/resetn_in] [get_bd_pins proc_sys_reset_100MHz/ext_reset_in] [get_bd_pins proc_sys_reset_142MHz/ext_reset_in] [get_bd_pins proc_sys_reset_166MHz/ext_reset_in] [get_bd_pins proc_sys_reset_200MHz/ext_reset_in] [get_bd_pins proc_sys_reset_41MHz/ext_reset_in] [get_bd_pins proc_sys_reset_50MHz/ext_reset_in] [get_bd_pins ps7/FCLK_RESET0_N]
  connect_bd_net -net ps7_FCLK_RESET2_N [get_bd_pins microphone_mgr_0/resetn_in] [get_bd_pins ps7/FCLK_RESET2_N]
  connect_bd_net -net ps7_GPIO_O [get_bd_pins ps7/GPIO_O] [get_bd_pins wireless_mgr_0/GPIO_from_Zynq]
  connect_bd_net -net ps7_GPIO_T [get_bd_pins ps7/GPIO_T] [get_bd_pins wireless_mgr_0/GPIO_dir]
  connect_bd_net -net ps7_SDIO0_CLK [get_bd_pins ps7/SDIO0_CLK] [get_bd_pins wireless_mgr_0/SDIO_CLK]
  connect_bd_net -net ps7_SDIO0_CMD_O [get_bd_pins ps7/SDIO0_CMD_O] [get_bd_pins wireless_mgr_0/SDIO_CMD_from_Zynq]
  connect_bd_net -net ps7_SDIO0_CMD_T [get_bd_pins ps7/SDIO0_CMD_T] [get_bd_pins wireless_mgr_0/SDIO_CMD_dir]
  connect_bd_net -net ps7_SDIO0_DATA_O [get_bd_pins ps7/SDIO0_DATA_O] [get_bd_pins wireless_mgr_0/SDIO_DATA_from_Zynq]
  connect_bd_net -net ps7_SDIO0_DATA_T [get_bd_pins ps7/SDIO0_DATA_T] [get_bd_pins wireless_mgr_0/SDIO_DATA_dir]
  connect_bd_net -net pwm_1_pwm_out [get_bd_ports PMOD1_LED] [get_bd_pins pwm_0/pwm_out]
  ...
  connect_bd_net -net wireless_mgr_0_GPIO_to_Zynq [get_bd_pins ps7/GPIO_I] [get_bd_pins wireless_mgr_0/GPIO_to_Zynq]
  connect_bd_net -net wireless_mgr_0_SDIO_CDN [get_bd_pins ps7/SDIO0_CDN] [get_bd_pins wireless_mgr_0/SDIO_CDN]
  connect_bd_net -net wireless_mgr_0_SDIO_CLK_FB [get_bd_pins ps7/SDIO0_CLK_FB] [get_bd_pins wireless_mgr_0/SDIO_CLK_FB]
  connect_bd_net -net wireless_mgr_0_SDIO_CMD_to_Zynq [get_bd_pins ps7/SDIO0_CMD_I] [get_bd_pins wireless_mgr_0/SDIO_CMD_to_Zynq]
  connect_bd_net -net wireless_mgr_0_SDIO_DATA_to_Zynq [get_bd_pins ps7/SDIO0_DATA_I] [get_bd_pins wireless_mgr_0/SDIO_DATA_to_Zynq]
  connect_bd_net -net wireless_mgr_0_SDIO_WP [get_bd_pins ps7/SDIO0_WP] [get_bd_pins wireless_mgr_0/SDIO_WP]
  ...
  connect_bd_net -net wireless_mgr_0_ZYNQ_UART_CTS [get_bd_pins bluetooth_uart/ctsn] [get_bd_pins wireless_mgr_0/ZYNQ_UART_CTS]
  connect_bd_net -net wireless_mgr_0_ZYNQ_UART_RX [get_bd_pins bluetooth_uart/sin] [get_bd_pins wireless_mgr_0/ZYNQ_UART_RX]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins pwm_0/ena] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins ps7/SDIO1_CDN] [get_bd_pins ps7/SDIO1_WP] [get_bd_pins xlconstant_1/dout]
  ...
  assign_bd_address -offset 0x41600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41610000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_iic_1/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs bluetooth_uart/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] -force
  ...
  set_property PFM_NAME {em.avnet.com:minized_sbc_base:minized_sbc_base:1.0} [get_files [current_bd_design].bd]
